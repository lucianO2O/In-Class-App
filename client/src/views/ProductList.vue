...
<template>
  ...
  <div v-if="products.isLoading" class="content">
    <p>Loading products...</p>
  </div>
  <div v-else-if="products.error" class="content has-text-danger">
    <p>Error: {{ products.error }}</p>
  </div>
  <div v-else-if="products.products.length === 0" class="content">
    <p>No products available</p>
  </div>
  <div v-else class="grid is-col-min-10 px-6">
